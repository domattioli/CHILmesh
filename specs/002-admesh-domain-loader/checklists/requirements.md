...
- [x] Success criteria are technology-agnostic — No framework/language specifics in criteria
...
- [x] Scope is clearly bounded — Method is single classmethod; layer computation deferred to existing `_skeletonize()`
...
- [x] User scenarios cover primary flows — P1 covers instance + dict variants (main use), P2 covers optional layer skip
