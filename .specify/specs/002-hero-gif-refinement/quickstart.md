...
| **SC-003** | Each stage boundary holds ≥ 1.5 s (≥ 15 frames @ 10 fps). | Inspect the schedule: Seed→Truss, Truss→FEM ≥ 15 held frames; the peel k=0 hold is 15 f (FEM→Peel). Confirm in the rendered GIF's held runs. |
