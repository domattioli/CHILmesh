...
def _write_2dm(tmp_path: Path, content: str, name: str = "mesh.2dm") -> Path:
    path = tmp_path / name
...
class Test2DMReader:
    ...
    def test_read_2dm_triangular_mesh(self, tmp_path):
...
E3T 2 1 3 4 0
"""
        tmpfile = _write_2dm(tmp_path, sms_content)
    ...
    def test_read_2dm_quad_mesh(self, tmp_path):
...
"""
    ...
    def test_read_2dm_mixed_mesh(self, tmp_path):
...
"""
    ...
    def test_read_2dm_with_comments(self, tmp_path):
...
"""
    ...
    def test_read_2dm_with_z_coordinates(self, tmp_path):
...
"""
    ...
    def test_read_2dm_empty_file(self, tmp_path):
        """Test that empty file raises ValueError."""
        tmpfile = _write_2dm(tmp_path, "", name="empty.2dm")
        with pytest.raises(ValueError, match="No nodes found"):
            chilmesh.CHILmesh.read_from_2dm(tmpfile)

    def test_read_2dm_compute_layers_false(self, tmp_path):
...
"""
    ...
    def test_read_2dm_from_admesh_domain(self, tmp_path):
...
"""
    ...
    def test_read_2dm_preserves_geometry(self, tmp_path):
