...
Final mixed-element mesh after angle-based smoothing — 466 corner-graded triangles surrounding 60 quads, all interior nodes relaxed by the Zhou & Shimada angle-based smoother (boundary pinned, median quality 0.733):

![Mixed-element mesh after angle-based smoothing](output/mixed_mesh_fem_final.png?v=3)
